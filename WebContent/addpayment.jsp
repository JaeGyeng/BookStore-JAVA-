...
<html>
    <head>
        ...
        <%  ArrayList<Basket> baskets = (ArrayList<Basket>) request.getAttribute("baskets");
            ...
            ArrayList<BookProduct> myproducts = (ArrayList<BookProduct>) request.getAttribute("myproducts");
        ...
        <table border="2px">
            ...
            <%
                for (int i = 0; i < baskets.size(); i++) {
                    ...
                    BookProduct product = myproducts.get(i);
            %> 
            <tbody>
                <tr>
                    <td align="center"><%=user.getUsername()%></td>
                    <td align="center"><%=product.getBookname()%></td>
